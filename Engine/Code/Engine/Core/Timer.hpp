...
public:
	...
	int m_intervals = 0;	// a way to track an interval duration
	double m_elapsedTime = 0;	// ...a way to track when the timer has elapsed (hopefully can give us remaining time and elapsed time)
};
